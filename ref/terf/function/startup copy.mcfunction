...
##crusher
# machine: Crusher
# recipe_type: Single Input
# input: Ice
# output: Snowball x1
# output_id: minecraft:snowball
# machine: Crusher
# recipe_type: Single Input
# input: Packed Ice
# output: Snowball x9
...
# input: Bone
# output: Bone Meal x6
# output_id: minecraft:bone_meal
# machine: Crusher
# recipe_type: Single Input
# input: Blaze Rod
# output: Blaze Powder x4
# output_id: minecraft:blaze_powder
# machine: Crusher
# recipe_type: Single Input
# input: Redstone
# output: Red Dye x1
# output_id: minecraft:red_dye

# machine: Crusher
# recipe_type: Single Input
# input: Stone
# output: Cobblestone x1
# output_id: minecraft:cobblestone
# machine: Crusher
# recipe_type: Single Input
# input: Cobblestone
# output: Gravel x1
# output_id: minecraft:gravel
# machine: Crusher
# recipe_type: Single Input
# input: Gravel
# output: Sand x1
# output_id: minecraft:sand
# machine: Crusher
# recipe_type: Single Input
# input: White Wool
# output: String x4
# output_id: minecraft:string
# machine: Crusher
# recipe_type: Single Input
# input: Amethyst Block
# output: Amethyst Dust x4
# output_id: amethyst_dust
# machine: Crusher
# recipe_type: Single Input
# input: Sugar Cane
# output: Sugar x2
# output_id: minecraft:sugar
# machine: Crusher
# recipe_type: Single Input
# input: Tnt
# output: Gunpowder x5
# output_id: minecraft:gunpowder

# machine: Crusher
# recipe_type: Single Input
# input: Netherite Ingot
# output: Netherite Dust x1
# output_id: netherite_dust
...
# machine: Crusher
# recipe_type: Single Input
# input: Raw Gold Block
# output: Gold Dust x18
# output_id: gold_dust

# machine: Crusher
# recipe_type: Single Input
# input: Copper Ingot
# output: Copper Dust x1
# output_id: copper_dust
# machine: Crusher
# recipe_type: Single Input
# input: Raw Copper
# output: Copper Dust x2
# output_id: copper_dust
# machine: Crusher
# recipe_type: Single Input
# input: Raw Copper Block
# output: Copper Dust x18
# output_id: copper_dust
...
# machine: Crusher
# recipe_type: Single Input
# input: Raw Iron Block
# output: Iron Dust x18
# output_id: iron_dust

# machine: Crusher
# recipe_type: Single Input
# input: Palladium Group Metal
# output: Palladium Group Metal Dust x1
# output_id: terf:palladium_group_metal_dust

##electrolyzer
# machine: Electrolyzer
# recipe_type: Single Input Fluid
# input: Water
# output_fluids:
# - Hydrogen x20 -> target 1
# - Oxygen x10 -> target 2
# machine: Electrolyzer
# recipe_type: Single Input Fluid
# input: Heavy Water
# output_fluids:
# - Deuterium x20 -> target 1
# - Oxygen x10 -> target 2
...
# input: Gold Dust
# output_fluids:
# - Gold Slurry x200 -> target 0
# machine: Wet Mill
# recipe_type: Single Input
# input: Palladium Group Metal Dust
# output_fluids:
# - Palladium Group Sludge x1000 -> target 0

##hadron collider
# machine: Hadron Collider
# recipe_type: Two Item Inputs
# inputs:
# - Slime Block
# - Coal
# output: Diamond x2
# output_id: minecraft:diamond
# machine: Hadron Collider
# recipe_type: Two Item Inputs
# inputs:
# - Diamond
# - Redstone
# output: Netherite Scrap x1
# output_id: minecraft:netherite_scrap
# machine: Hadron Collider
# recipe_type: Two Item Inputs
# inputs:
# - Iron Ingot
# - Iron Nugget
# output: Gold Nugget x12
# output_id: minecraft:gold_nugget
# machine: Hadron Collider
# recipe_type: Two Item Inputs
# inputs:
# - Iron Nugget
# - Gold Nugget
# output: Glowstone Dust x2
# output_id: minecraft:glowstone_dust
# machine: Hadron Collider
# recipe_type: Two Item Inputs
# inputs:
# - Iron Ingot
# - Gold Ingot
# output: Copper Ingot x2
# output_id: minecraft:copper_ingot
# machine: Hadron Collider
# recipe_type: Two Item Inputs
# inputs:
# - Copper Ingot
# - Stone
# output: Iron Ingot x4
...
# - Netherite Ingot
# - Glass
# output: Nether Star x1
# output_id: minecraft:nether_star
# machine: Hadron Collider
# recipe_type: Two Item Inputs
# inputs:
# - Gold Nugget
...
# - Charcoal
# output: Coal x7
# output_id: minecraft:coal
# machine: Hadron Collider
# recipe_type: Two Item Inputs
# inputs:
# - Slime Ball
# - Netherite Dust
# output: Ender Pearl x1
# output_id: minecraft:ender_pearl
# machine: Hadron Collider
# recipe_type: Two Item Inputs
# inputs:
# - Red Bed
# - Ancient Debris
# output: Special Function Output
# note: Summons a black hole via terf:entity/black_hole/summon
...
# - Nether Star
# - Netherite Scrap
# output: Netherite Upgrade Smithing Template x1
# output_id: minecraft:netherite_upgrade_smithing_template

##opencore
# machine: Opencore
# recipe_type: Single Input Staged Process
# input: Netherite Scrap
# output: Netherite Ingot x8
# output_id: minecraft:netherite_ingot
# process_steps:
# - neth. scrap
# - 8x neth. ingot
# - MELT
...
# recipe_type: Single Input Staged Process
# input: Emerald Block
# output: Diamond Block x3
# output_id: minecraft:diamond_block
# process_steps:
# - emerald block
# - 3x diamond block
# - MELT
...
# recipe_type: Single Input Staged Process
# input: Quartz
# output: Amethyst Shard x20
# output_id: minecraft:amethyst_shard
# process_steps:
# - quartz
# - 20x amethyst shard
# - EXPOSE
...
# recipe_type: Single Input Staged Process
# input: Amethyst Block
# output: Ochre Froglight x1
# output_id: minecraft:ochre_froglight
# process_steps:
# - amethyst block
# - ochre froglight
# - FORM
...
# machine: Opencore
# recipe_type: Single Input Staged Process
# input: Netherite Block
# output: Heavy Core x1
# output_id: minecraft:heavy_core
# process_steps:
# - netherite block
# - heavy core
# - PREPARE
...
# recipe_type: Single Input
# input: Chicken
# output: Cooked Chicken x1
# output_id: minecraft:cooked_chicken
# machine: Ebf
# recipe_type: Single Input
# input: Sand
# output: Glass x1
...
# recipe_type: Single Input
# input: Gold Dust
# output: Gold Ingot x1
# output_id: minecraft:gold_ingot
# machine: Ebf
# recipe_type: Single Input
# input: Copper Dust
...
##electric press
# machine: Electric Press
# recipe_type: Single Input
# input: Blaze Powder
# output: Blaze Rod x1
# output_id: minecraft:blaze_rod
# machine: Electric Press
# recipe_type: Single Input
# input: Honeycomb
# output: Slime Ball x1
# output_id: minecraft:slime_ball
# machine: Electric Press
# recipe_type: Single Input
# input: Honeycomb Block
# output: Slime Ball x4
# output_id: minecraft:slime_ball
# machine: Electric Press
# recipe_type: Single Input
# input: String
# output: Leather x1
# output_id: minecraft:leather
# machine: Electric Press
# recipe_type: Single Input
# input: Netherite Scrap
# output: Ancient Debris x1
# output_id: minecraft:ancient_debris

##dem
# machine: Dem
# recipe_type: Single Input
# input: Blue Glazed Terracotta
# output_fluid:
# - Daonium x1 -> receptacle 0

##rolling mill
# machine: Rolling Mill
# recipe_type: Single Input
# input: Copper Ingot
# output: Copper Plate x1
# output_id: copper_plate
# machine: Rolling Mill
# recipe_type: Single Input
# input: Copper Plate
# output: Copper Foil x4
# output_id: copper_foil
# machine: Rolling Mill
# recipe_type: Single Input
# input: Copper Rod
# output: Copper Wire x4
# output_id: copper_wire

# machine: Rolling Mill
# recipe_type: Single Input
# input: Gold Ingot
# output: Gold Plate x1
# output_id: gold_plate
# machine: Rolling Mill
# recipe_type: Single Input
# input: Gold Plate
# output: Gold Foil x4
...
# recipe_type: Single Input
# input: Iron Ingot
# output: Iron Plate x1
# output_id: iron_plate
# machine: Rolling Mill
# recipe_type: Single Input
# input: Iron Plate
# output: Iron Foil x4
...
# recipe_type: Single Input
# input: Netherite Ingot
# output: Netherite Plate x1
# output_id: netherite_plate
# machine: Rolling Mill
# recipe_type: Single Input
# input: Netherite Plate
# output: Netherite Foil x4
# output_id: netherite_foil
# machine: Rolling Mill
# recipe_type: Single Input
# input: Netherite Rod
# output: Netherite Wire x4
# output_id: netherite_wire

##extrusion press
# machine: Extrusion Press
# recipe_type: Material + Mold
# inputs:
# - Copper Ingot
# - Extrusion Mold Bar
# output: Copper Bar x1
# output_id: copper_bar
# machine: Extrusion Press
# recipe_type: Material + Mold
# inputs:
# - Copper Bar
# - Extrusion Mold Roller
# output: Copper Spring x1
# output_id: copper_spring
# machine: Extrusion Press
# recipe_type: Material + Mold
# inputs:
# - Copper Rod
# - Extrusion Mold Roller
# output: Small Copper Spring x1
# output_id: small_copper_spring
# machine: Extrusion Press
# recipe_type: Material + Mold
# inputs:
# - Copper Bolt
# - Extrusion Mold Roller
# output: Copper Ring x1
# output_id: copper_ring
# machine: Extrusion Press
# recipe_type: Material + Mold
# inputs:
# - Copper Bolt
# - Extrusion Mold Threading
# output: Copper Screw x1
# output_id: copper_screw
...
# - Gold Bar
# - Extrusion Mold Roller
# output: Gold Spring x1
# output_id: gold_spring
# machine: Extrusion Press
# recipe_type: Material + Mold
# inputs:
# - Gold Rod
# - Extrusion Mold Roller
# output: Small Gold Spring x1
# output_id: small_gold_spring
# machine: Extrusion Press
# recipe_type: Material + Mold
# inputs:
# - Gold Bolt
...
# - Gold Bolt
# - Extrusion Mold Threading
# output: Gold Screw x1
# output_id: gold_screw
...
# - Iron Bar
# - Extrusion Mold Roller
# output: Iron Spring x1
# output_id: iron_spring
# machine: Extrusion Press
# recipe_type: Material + Mold
# inputs:
# - Iron Rod
# - Extrusion Mold Roller
# output: Small Iron Spring x1
# output_id: small_iron_spring
# machine: Extrusion Press
# recipe_type: Material + Mold
# inputs:
# - Iron Bolt
...
# - Iron Bolt
# - Extrusion Mold Threading
# output: Iron Screw x1
# output_id: iron_screw
...
# - Netherite Ingot
# - Extrusion Mold Bar
# output: Netherite Bar x1
# output_id: netherite_bar
# machine: Extrusion Press
# recipe_type: Material + Mold
# inputs:
# - Netherite Bar
# - Extrusion Mold Roller
# output: Netherite Spring x1
# output_id: netherite_spring
# machine: Extrusion Press
# recipe_type: Material + Mold
# inputs:
# - Netherite Rod
# - Extrusion Mold Roller
# output: Small Netherite Spring x1
# output_id: small_netherite_spring
# machine: Extrusion Press
# recipe_type: Material + Mold
# inputs:
# - Netherite Bolt
# - Extrusion Mold Roller
# output: Netherite Ring x1
# output_id: netherite_ring
# machine: Extrusion Press
# recipe_type: Material + Mold
# inputs:
# - Netherite Bolt
# - Extrusion Mold Threading
# output: Netherite Screw x1
# output_id: netherite_screw

##shearing press
# machine: Shearing Press
# recipe_type: Single Input
# input: Copper Bar
# output: Copper Rod x2
# output_id: copper_rod
# machine: Shearing Press
# recipe_type: Single Input
# input: Copper Rod
# output: Copper Bolt x2
# output_id: copper_bolt
# machine: Shearing Press
# recipe_type: Single Input
# input: Copper Spring
# output: Small Copper Spring x2
# output_id: small_copper_spring
...
# recipe_type: Single Input
# input: Iron Spring
# output: Small Iron Spring x2
# output_id: small_iron_spring

# machine: Shearing Press
# recipe_type: Single Input
# input: Netherite Bar
# output: Netherite Rod x2
# output_id: netherite_rod
# machine: Shearing Press
# recipe_type: Single Input
# input: Netherite Rod
# output: Netherite Bolt x2
# output_id: netherite_bolt
# machine: Shearing Press
# recipe_type: Single Input
# input: Netherite Spring
# output: Small Netherite Spring x2
# output_id: small_netherite_spring

##fission fuel loader
# machine: Fission Fuel Loader
# recipe_type: Special Action
# mode: load
# input: Uranium 235 Oxide Pellet
# output: Fuel Rod Marker For Uranium 235 Oxide
# machine: Fission Fuel Loader
# recipe_type: Special Action
# mode: unload
# input: Uranium 235 Oxide
# output: Unload Action

##large fluid solidifier
# machine: Large Fluid Solidifier
# recipe_type: Single Input
# input: Mineral Magma
# machine: Large Fluid Solidifier
# recipe_type: Single Input
...
# machine: Large Fluid Solidifier
# recipe_type: Single Input
# input: Palladium Group Sludge
# output: Nanopore Palladium Catalyst x1
# output_id: terf:nanopore_palladium_catalyst
...
# AI_REFERENCE | assembler recipes use a flat item list from items:[{id:"...",count:N},...]
# AI_REFERENCE | assembler output is defined by the z command, not by a 3x3 dot-path grid
# AI_REFERENCE | quick lookup: output=hoverbike | machine=assembler | search_hint=Hoverbike_terf00000
# output: Hoverbike
# output_id: Hoverbike
# machine: assembler
# ingredients:
...
# AI_RECIPE_REFERENCE_START
# AI_REFERENCE | recipe root format: data modify storage terf:constants recipes.<machine>...
# AI_REFERENCE | fabricator format: recipes.fabricator.<slot1>.<slot2>.<slot3>.<slot4>.<slot5>.<slot6>.<slot7>.<slot8>.<slot9>
# AI_REFERENCE | fabricator slots are a 3x3 grid read left-to-right, top-to-bottom
# AI_REFERENCE | z or .z. means an empty space in the grid
# AI_REFERENCE | entries starting with minecraft: are vanilla items
# AI_REFERENCE | entries starting with terf: are terf items
# AI_REFERENCE | entries without a namespace such as copper_plate or iron_screw are custom ids used by this pack
# AI_REFERENCE | custom_item_summon outputs use the id inside {id:"..."} or {id:...}
# AI_REFERENCE | summon item outputs should prefer custom_data.id when present; otherwise use Item.id
# AI_REFERENCE | assembler recipes are not grids; they use items:[...] flat ingredient lists
#
# AI_QUICK_INDEX | fabricator outputs below
# AI_QUICK_INDEX | output=copper_rotor | machine=fabricator | search_hint=#parts
# AI_QUICK_INDEX | output=netherite_rotor | machine=fabricator | search_hint=#parts
# AI_QUICK_INDEX | output=gold_rotor | machine=fabricator | search_hint=#parts
# AI_QUICK_INDEX | output=iron_rotor | machine=fabricator | search_hint=#parts
# AI_QUICK_INDEX | output=copper_extrusion_mold_bar | machine=fabricator | search_hint=#extrusion molds
# AI_QUICK_INDEX | output=netherite_extrusion_mold_bar | machine=fabricator | search_hint=#extrusion molds
# AI_QUICK_INDEX | output=gold_extrusion_mold_bar | machine=fabricator | search_hint=#extrusion molds
# AI_QUICK_INDEX | output=iron_extrusion_mold_bar | machine=fabricator | search_hint=#extrusion molds
# AI_QUICK_INDEX | output=copper_extrusion_mold_roller | machine=fabricator | search_hint=#extrusion molds
# AI_QUICK_INDEX | output=netherite_extrusion_mold_roller | machine=fabricator | search_hint=#extrusion molds
# AI_QUICK_INDEX | output=gold_extrusion_mold_roller | machine=fabricator | search_hint=#extrusion molds
# AI_QUICK_INDEX | output=iron_extrusion_mold_roller | machine=fabricator | search_hint=#extrusion molds
# AI_QUICK_INDEX | output=copper_extrusion_mold_threading | machine=fabricator | search_hint=#extrusion molds
# AI_QUICK_INDEX | output=netherite_extrusion_mold_threading | machine=fabricator | search_hint=#extrusion molds
# AI_QUICK_INDEX | output=gold_extrusion_mold_threading | machine=fabricator | search_hint=#extrusion molds
# AI_QUICK_INDEX | output=iron_extrusion_mold_threading | machine=fabricator | search_hint=#extrusion molds
# AI_QUICK_INDEX | output=terf:laser_diode_lv | machine=fabricator | search_hint=#lv laser diode
# AI_QUICK_INDEX | output=terf:laser_diode_hv | machine=fabricator | search_hint=#hv laser diode
# AI_QUICK_INDEX | output=terf:battery_mv | machine=fabricator | search_hint=#mv battery
# AI_QUICK_INDEX | output=terf:heat_sink | machine=fabricator | search_hint=#heat sink
# AI_QUICK_INDEX | output=terf:magnetron | machine=fabricator | search_hint=#magnetron
# AI_QUICK_INDEX | output=terf:art_mount | machine=fabricator | search_hint=#A.R.T Mount
# AI_QUICK_INDEX | output=terf:art_turret | machine=fabricator | search_hint=#A.R.T Turret
# AI_QUICK_INDEX | output=terf:art_rail | machine=fabricator | search_hint=#A.R.T Rail
# AI_QUICK_INDEX | output=terf:multiblock_core | machine=fabricator | search_hint=#multiblock core
# AI_QUICK_INDEX | output=terf:multimeter | machine=fabricator | search_hint=#multimeter
# AI_QUICK_INDEX | output=terf:dosimeter | machine=fabricator | search_hint=#dosimeter
# AI_QUICK_INDEX | output=terf:hard_hat | machine=fabricator | search_hint=#hard hat
# AI_QUICK_INDEX | output=terf:laser_pistol | machine=fabricator | search_hint=#laser pistol
# AI_QUICK_INDEX | output=terf:taser | machine=fabricator | search_hint=#taser
# AI_QUICK_INDEX | output=terf:wrench | machine=fabricator | search_hint=#wrench
# AI_QUICK_INDEX | output=terf:photon_cannon | machine=fabricator | search_hint=#photon cannon
# AI_QUICK_INDEX | output=terf:linker | machine=fabricator | search_hint=#linker
# AI_QUICK_INDEX | output=terf:plasma_pickaxe | machine=fabricator | search_hint=#plasma pickaxe
# AI_QUICK_INDEX | output=terf:shrink_ray | machine=fabricator | search_hint=#shrink ray
# AI_QUICK_INDEX | output=terf:crane_remote | machine=fabricator | search_hint=#crane remote
# AI_QUICK_INDEX | output=terf:tau_cannon | machine=fabricator | search_hint=#tau cannon
# AI_QUICK_INDEX | output=terf:fire_extinguisher | machine=fabricator | search_hint=#fire extinguisher
# AI_QUICK_INDEX | output=terf:art_base | machine=fabricator | search_hint=#A.R.T base
# AI_QUICK_INDEX | output=terf:syringe | machine=fabricator | search_hint=#syringe
# AI_QUICK_INDEX | output=terf:monocular | machine=fabricator | search_hint=#neutron monocular
# AI_QUICK_INDEX | output=terf:fluid_id | machine=fabricator | search_hint=#fluid id tool
# AI_QUICK_INDEX | output=orange_glazed_terracotta | machine=fabricator | search_hint=#battery module
# AI_QUICK_INDEX | output=white_glazed_terracotta | machine=fabricator | search_hint=#mcfr assembly
# AI_QUICK_INDEX | output=music_disc_11 | machine=fabricator | search_hint=#greg music disc
# AI_QUICK_INDEX | output=petrified_oak_slab | machine=fabricator | search_hint=#coil
# AI_QUICK_INDEX | output=terf:capsule_housing | machine=fabricator | search_hint=#capsule housing
# AI_QUICK_INDEX | output=terf:electromagnetic_capsule | machine=fabricator | search_hint=#electromagnetic capsule
# AI_QUICK_INDEX | output=terf:pressurized_capsule | machine=fabricator | search_hint=#pressurized capsule
# AI_QUICK_INDEX | output=minecraft:ender_chest | machine=fabricator | search_hint=#ender chest
# AI_QUICK_INDEX | output=terf:custom_button | machine=fabricator | search_hint=#custom button
# AI_QUICK_INDEX | output=terf:electron_bomb | machine=fabricator | search_hint=#electron bomb
#
# AI_RECURSIVE_TERF_DEPENDENCIES | only follow terf outputs and terf ingredients in recursive mode
# AI_RECURSIVE_TERF_DEPENDENCIES | output=terf:magnetron | depends_on=terf:heat_sink
# AI_RECURSIVE_TERF_DEPENDENCIES | output=terf:art_turret | depends_on=terf:art_rail,terf:laser_diode_hv
# AI_RECURSIVE_TERF_DEPENDENCIES | output=terf:art_rail | depends_on=terf:heat_sink
# AI_RECURSIVE_TERF_DEPENDENCIES | output=terf:laser_pistol | depends_on=terf:battery_mv
# AI_RECURSIVE_TERF_DEPENDENCIES | output=terf:taser | depends_on=terf:battery_mv
# AI_RECURSIVE_TERF_DEPENDENCIES | output=terf:photon_cannon | depends_on=terf:battery_mv
# AI_RECURSIVE_TERF_DEPENDENCIES | output=terf:linker | depends_on=terf:laser_diode_lv,terf:battery_mv
# AI_RECURSIVE_TERF_DEPENDENCIES | output=terf:plasma_pickaxe | depends_on=terf:laser_diode_hv,terf:battery_mv
# AI_RECURSIVE_TERF_DEPENDENCIES | output=terf:shrink_ray | depends_on=terf:battery_mv,terf:laser_diode_hv
# AI_RECURSIVE_TERF_DEPENDENCIES | output=terf:crane_remote | depends_on=terf:battery_mv
# AI_RECURSIVE_TERF_DEPENDENCIES | output=terf:tau_cannon | depends_on=terf:heat_sink,terf:laser_diode_hv,terf:magnetron
# AI_RECURSIVE_TERF_DEPENDENCIES | output=terf:electromagnetic_capsule | depends_on=terf:battery_mv,terf:capsule_housing
# AI_RECURSIVE_TERF_DEPENDENCIES | output=terf:electron_bomb | depends_on=terf:electromagnetic_capsule
# AI_RECIPE_REFERENCE_END

#parts
# output: Copper Rotor
# output_id: copper_rotor
# machine: fabricator
# label: parts
# ingredients:
# - Copper Screw | Copper Plate | Copper Screw
# - Copper Plate | Copper Ring | Copper Plate
# - Copper Screw | Copper Plate | Copper Screw
# output: Netherite Rotor
# output_id: netherite_rotor
# machine: fabricator
# label: parts
# ingredients:
# - Netherite Screw | Netherite Plate | Netherite Screw
# - Netherite Plate | Netherite Ring | Netherite Plate
# - Netherite Screw | Netherite Plate | Netherite Screw
# output: Gold Rotor
# output_id: gold_rotor
# machine: fabricator
# label: parts
# ingredients:
# - Gold Screw | Gold Plate | Gold Screw
# - Gold Plate | Gold Ring | Gold Plate
# - Gold Screw | Gold Plate | Gold Screw
# output: Iron Rotor
# output_id: iron_rotor
# machine: fabricator
# label: parts
# ingredients:
# - Iron Screw | Iron Plate | Iron Screw
# - Iron Plate | Iron Ring | Iron Plate
# - Iron Screw | Iron Plate | Iron Screw

#extrusion molds
# output: Copper Extrusion Mold Bar
# output_id: copper_extrusion_mold_bar
# machine: fabricator
# label: extrusion molds
# ingredients:
# - Empty Space | Copper Plate | Empty Space
# - Copper Plate | Stone Button | Copper Plate
# - Empty Space | Copper Plate | Empty Space
# output: Netherite Extrusion Mold Bar
# output_id: netherite_extrusion_mold_bar
# machine: fabricator
# label: extrusion molds
# ingredients:
# - Empty Space | Netherite Plate | Empty Space
# - Netherite Plate | Stone Button | Netherite Plate
# - Empty Space | Netherite Plate | Empty Space
# output: Gold Extrusion Mold Bar
# output_id: gold_extrusion_mold_bar
# machine: fabricator
# label: extrusion molds
# ingredients:
# - Empty Space | Gold Plate | Empty Space
# - Gold Plate | Stone Button | Gold Plate
# - Empty Space | Gold Plate | Empty Space
# output: Iron Extrusion Mold Bar
# output_id: iron_extrusion_mold_bar
# machine: fabricator
# label: extrusion molds
# ingredients:
# - Empty Space | Iron Plate | Empty Space
# - Iron Plate | Stone Button | Iron Plate
# - Empty Space | Iron Plate | Empty Space

# output: Copper Extrusion Mold Roller
# output_id: copper_extrusion_mold_roller
# machine: fabricator
# label: extrusion molds
# ingredients:
# - Empty Space | Copper Plate | Empty Space
# - Copper Plate | Grindstone | Copper Plate
# - Empty Space | Copper Plate | Empty Space
# output: Netherite Extrusion Mold Roller
# output_id: netherite_extrusion_mold_roller
# machine: fabricator
# label: extrusion molds
# ingredients:
# - Empty Space | Netherite Plate | Empty Space
# - Netherite Plate | Grindstone | Netherite Plate
# - Empty Space | Netherite Plate | Empty Space
# output: Gold Extrusion Mold Roller
# output_id: gold_extrusion_mold_roller
# machine: fabricator
# label: extrusion molds
# ingredients:
# - Empty Space | Gold Plate | Empty Space
# - Gold Plate | Grindstone | Gold Plate
# - Empty Space | Gold Plate | Empty Space
# output: Iron Extrusion Mold Roller
# output_id: iron_extrusion_mold_roller
# machine: fabricator
# label: extrusion molds
# ingredients:
# - Empty Space | Iron Plate | Empty Space
# - Iron Plate | Grindstone | Iron Plate
# - Empty Space | Iron Plate | Empty Space

# output: Copper Extrusion Mold Threading
# output_id: copper_extrusion_mold_threading
# machine: fabricator
# label: extrusion molds
# ingredients:
# - Empty Space | Copper Plate | Empty Space
# - Copper Plate | Copper Bolt | Copper Plate
# - Empty Space | Copper Plate | Empty Space
# output: Netherite Extrusion Mold Threading
# output_id: netherite_extrusion_mold_threading
# machine: fabricator
# label: extrusion molds
# ingredients:
# - Empty Space | Netherite Plate | Empty Space
# - Netherite Plate | Netherite Bolt | Netherite Plate
# - Empty Space | Netherite Plate | Empty Space
# output: Gold Extrusion Mold Threading
# output_id: gold_extrusion_mold_threading
# machine: fabricator
# label: extrusion molds
# ingredients:
# - Empty Space | Gold Plate | Empty Space
# - Gold Plate | Gold Bolt | Gold Plate
# - Empty Space | Gold Plate | Empty Space
# output: Iron Extrusion Mold Threading
# output_id: iron_extrusion_mold_threading
# machine: fabricator
# label: extrusion molds
# ingredients:
# - Empty Space | Iron Plate | Empty Space
# - Iron Plate | Iron Bolt | Iron Plate
# - Empty Space | Iron Plate | Empty Space

#lv laser diode
# output: Laser Diode Lv
# output_id: terf:laser_diode_lv
# machine: fabricator
# label: lv laser diode
# ingredients:
# - Iron Nugget | Glass | Iron Nugget
# - Gold Plate | Diamond | Gold Plate
# - Waxed Lightning Rod | Waxed Lightning Rod | Waxed Lightning Rod

#hv laser diode
# output: Laser Diode Hv
# output_id: terf:laser_diode_hv
# machine: fabricator
# label: hv laser diode
# ingredients:
# - Netherite Plate | Netherite Plate | Empty Space
# - Diamond Block | Amethyst Shard | Waxed Copper Bulb
# - Netherite Plate | Netherite Plate | Empty Space

#mv battery
# output: Battery Mv
# output_id: terf:battery_mv
# machine: fabricator
# label: mv battery
# ingredients:
# - Gold Plate | Gold Plate | Iron Plate
# - Glow Ink Sac | Coal | Glow Ink Sac
# - Copper Plate | Copper Plate | Copper Plate

#heat sink
# output: Heat Sink
# output_id: terf:heat_sink
# machine: fabricator
# label: heat sink
# ingredients:
# - Empty Space | Iron Nugget | Empty Space
# - Iron Plate | Heavy Weighted Pressure Plate | Iron Plate
# - Empty Space | Iron Nugget | Empty Space

#magnetron
# output: Magnetron
# output_id: terf:magnetron
# machine: fabricator
# label: magnetron
# ingredients:
# - Gold Plate | Waxed Lightning Rod | Gold Plate
# - Heat Sink | Copper Grate | Heat Sink
# - Heat Sink | Lodestone | Heat Sink

#A.R.T Mount
# output: Art Mount
# output_id: terf:art_mount
# machine: fabricator
# label: A.R.T Mount
# ingredients:
# - Anvil | Empty Space | Anvil
# - Iron Block | Empty Space | Iron Block
# - Netherite Ingot | Netherite Plate | Netherite Ingot

#A.R.T Turret
# output: Art Turret
# output_id: terf:art_turret
# machine: fabricator
# label: A.R.T Turret
# ingredients:
# - Art Rail | Art Rail | Waxed Copper Bulb
# - Heavy Core | Laser Diode Hv | Netherite Block
# - Art Rail | Art Rail | Waxed Copper Bulb

#A.R.T Rail
# output: Art Rail
# output_id: terf:art_rail
# machine: fabricator
# label: A.R.T Rail
# ingredients:
# - Netherite Plate | Netherite Plate | Netherite Plate
# - Anvil | Anvil | Anvil
...
#multiblock core
# output: Multiblock Core
# output_id: terf:multiblock_core
# machine: fabricator
# label: multiblock core
# ingredients:
# - Redstone | Iron Ingot | Copper Block
# - Iron Ingot | Diamond | Iron Ingot
# - Copper Block | Iron Ingot | Redstone

#multimeter
# output: Multimeter
# output_id: terf:multimeter
# machine: fabricator
# label: multimeter
# ingredients:
# - Tripwire Hook | Redstone Torch | Tripwire Hook
# - Iron Chain | Comparator | Iron Chain
# - Empty Space | Iron Nugget | Empty Space

#dosimeter
# output: Dosimeter
# output_id: terf:dosimeter
# machine: fabricator
# label: dosimeter
# ingredients:
# - Oxidized Copper Bulb | Note Block | Iron Nugget
# - Redstone | Observer | Amethyst Shard
# - Empty Space | Empty Space | Empty Space

#hard hat
# output: Hard Hat
# output_id: terf:hard_hat
# machine: fabricator
# label: hard hat
# ingredients:
# - Empty Space | Iron Ingot | Empty Space
# - Iron Nugget | Leather Helmet | Iron Nugget
# - Empty Space | Yellow Dye | Empty Space

#laser pistol
# output: Laser Pistol
# output_id: terf:laser_pistol
# machine: fabricator
# label: laser pistol
# ingredients:
# - Diamond | Netherite Ingot | Redstone Block
# - Stone Button | Observer | Comparator
# - Battery Mv | Iron Chain | Waxed Lightning Rod

#taser
# output: Taser
# output_id: terf:taser
# machine: fabricator
# label: taser
# ingredients:
# - Iron Chain | Netherite Scrap | Redstone Block
# - Redstone Torch | Stone Button | Quartz
# - Empty Space | Battery Mv | Waxed Lightning Rod

#wrench
# output: Wrench
# output_id: terf:wrench
# machine: fabricator
# label: wrench
# ingredients:
# - Iron Nugget | Iron Ingot | Heavy Weighted Pressure Plate
# - Empty Space | Waxed Lightning Rod | Iron Nugget
# - Empty Space | Red Dye | Empty Space

#photon cannon
# output: Photon Cannon
# output_id: terf:photon_cannon
# machine: fabricator
# label: photon cannon
# ingredients:
# - Redstone Torch | Netherite Scrap | Redstone Block
# - Glass | Waxed Copper Bulb | Waxed Copper Bulb
# - Battery Mv | Stone Button | Waxed Lightning Rod

#linker
# output: Linker
# output_id: terf:linker
# machine: fabricator
# label: linker
# ingredients:
# - Empty Space | Iron Plate | Iron Plate
# - Glass Pane | Laser Diode Lv | Battery Mv
# - Empty Space | Stone Button | Waxed Lightning Rod

#plasma pickaxe
# output: Plasma Pickaxe
# output_id: terf:plasma_pickaxe
# machine: fabricator
# label: plasma pickaxe
# ingredients:
# - Netherite Pickaxe | Netherite Axe | Laser Diode Hv
# - Laser Diode Hv | Comparator | Waxed Lightning Rod
# - Empty Space | Battery Mv | Waxed Lightning Rod
...
#shrink ray
# output: Shrink Ray
# output_id: terf:shrink_ray
# machine: fabricator
# label: shrink ray
# ingredients:
# - Netherite Plate | Copper Plate | Battery Mv
# - Comparator | Beacon | Laser Diode Hv
# - Netherite Plate | Stone Button | Waxed Lightning Rod

#crane remote
# output: Crane Remote
# output_id: terf:crane_remote
# machine: fabricator
# label: crane remote
# ingredients:
# - Waxed Lightning Rod | Redstone Torch | Acacia Sign
# - Copper Plate | Battery Mv | Stone Button
# - Empty Space | Copper Plate | Stone Button

#tau cannon
# output: Tau Cannon
# output_id: terf:tau_cannon
# machine: fabricator
# label: tau cannon
# ingredients:
# - Copper Plate | Netherite Plate | Heat Sink
# - Calibrated Sculk Sensor | Laser Diode Hv | Magnetron
# - Copper Plate | Waxed Oxidized Copper Bulb | Beacon

#fire extinguisher
# output: Fire Extinguisher
# output_id: terf:fire_extinguisher
# machine: fabricator
# label: fire extinguisher
# ingredients:
# - Empty Space | Empty Space | Lever
# - Waxed Lightning Rod | Stone Button | Lever
# - Iron Plate | Powder Snow Bucket | Iron Plate

#A.R.T base
# output: Art Base
# output_id: terf:art_base
# machine: fabricator
# label: A.R.T base
# ingredients:
# - Netherite Plate | Iron Block | Netherite Plate
# - Iron Block | Netherite Ingot | Iron Block
# - Netherite Plate | Iron Block | Netherite Plate

#syringe
# output: Syringe
# output_id: terf:syringe
# machine: fabricator
# label: syringe
# ingredients:
# - Empty Space | Glass | Heavy Weighted Pressure Plate
# - Glass | Empty Space | Glass
# - Waxed Lightning Rod | Glass | Empty Space

#neutron monocular
# output: Monocular
# output_id: terf:monocular
# machine: fabricator
# label: neutron monocular
# ingredients:
# - Sculk Sensor | Netherite Scrap | Petrified Oak Slab
# - Netherite Scrap | Spyglass | Netherite Scrap
# - Battery Mv | Netherite Scrap | Stone Button

#fluid id tool
# output: Fluid Id
# output_id: terf:fluid_id
# machine: fabricator
# label: fluid id tool
# ingredients:
# - Observer | Redstone Torch | Redstone
# - Empty Space | Empty Space | Copper Plate
# - Iron Plate | Iron Plate | Glass

#battery module
# output: Orange Glazed Terracotta
# output_id: orange_glazed_terracotta
# machine: fabricator
# label: battery module
# ingredients:
# - Waxed Lightning Rod | Iron Plate | Waxed Lightning Rod
# - Iron Chain | Battery Mv | Iron Chain
# - Iron Plate | Brown Glazed Terracotta | Iron Plate

#mcfr assembly
# output: White Glazed Terracotta
# output_id: white_glazed_terracotta
# machine: fabricator
# label: mcfr assembly
# ingredients:
# - Heat Sink | Heat Sink | Waxed Lightning Rod
# - Heat Sink | Heat Sink | Brown Glazed Terracotta
# - Waxed Lightning Rod | Brown Glazed Terracotta | Nanopore Palladium Catalyst

#greg music disc
# output: Music Disc 11
# output_id: music_disc_11
# machine: fabricator
# label: greg music disc
# ingredients:
# - Netherite Rotor | Copper Rotor | Iron Rotor
# - Gold Rotor | Netherite Block | Gold Rotor
# - Iron Rotor | Copper Rotor | Netherite Rotor

#coil
# output: Petrified Oak Slab
# output_id: petrified_oak_slab
# machine: fabricator
# label: coil
# ingredients:
# - Copper Wire | Copper Wire | Copper Wire
# - Copper Wire | Iron Bolt | Copper Wire
# - Copper Wire | Copper Wire | Copper Wire

#capsule housing
# output: Capsule Housing
# output_id: terf:capsule_housing
# machine: fabricator
# label: capsule housing
# ingredients:
# - Iron Bar | Copper Spring | Iron Bar
# - Iron Plate | Iron Bolt | Iron Plate
# - Iron Plate | Iron Bolt | Iron Plate

#electromagnetic capsule
# output: Electromagnetic Capsule
# output_id: terf:electromagnetic_capsule
# machine: fabricator
# label: electromagnetic capsule
# ingredients:
# - Petrified Oak Slab | Battery Mv | Petrified Oak Slab
# - Netherite Bar | Capsule Housing | Netherite Bar
# - Petrified Oak Slab | Gold Spring | Petrified Oak Slab

#pressurized capsule
# output: Pressurized Capsule
# output_id: terf:pressurized_capsule
# machine: fabricator
# label: pressurized capsule
# ingredients:
# - Iron Block | Iron Block | Iron Block
# - Iron Spring | Capsule Housing | Iron Bars
# - Dried Kelp | Copper Bolt | Small Iron Spring

#ender chest
# output: Ender Chest
# output_id: minecraft:ender_chest
# machine: fabricator
# label: ender chest
# ingredients:
# - Netherite Bar | Acacia Sign | Crying Obsidian
# - Chest | End Crystal | Gold Rotor
# - Crying Obsidian | Ender Eye | Loom

#custom button
# output: Custom Button
# output_id: terf:custom_button
# machine: fabricator
# label: custom button
# ingredients:
# - Empty Space | Redstone Torch | Empty Space
# - Empty Space | Birch Button | Small Copper Spring
# - Empty Space | Calibrated Sculk Sensor | Empty Space

#electron bomb
# output: Electron Bomb
# output_id: terf:electron_bomb
# machine: fabricator
# label: electron bomb
# ingredients:
# - Nanopore Palladium Catalyst | Comparator | Acacia Hanging Sign
# - Electromagnetic Capsule | Conduit | Electromagnetic Capsule
# - Observer | Granite Slab | Observer
